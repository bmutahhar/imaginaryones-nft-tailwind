...
import video from "../assets/rainbow-circle-black.5b72381.mp4";
import image from "../assets/rainbow-circle-black.25ba983.jpg";

const OnBoardingScreen = () => {
  let navigate = useNavigate();
  useEffect(() => {
    setTimeout(() => {
      navigate("../presale-mint", { replace: true });
    }, 3000);
  }, [navigate]);

  return (
    <>
      <section classNameName="min-h-screen bg-[#fff0f2] flex justify-center items-center">
        <div className="v-application--wrap">
          <div className="io-preloader">
            <div className="io-preloader__content">
              <div className="io-preloader__rainbow">
                <video
                  autoPlay
                  playsInline
                  muted
              ...
              <div className="io-preloader__text">Loading...</div>
            </div>
            <div className="io__buttons"></div>
            <div
              className="io-preloader__items"
              style={{ perspective: "1000px" }}
            >
              <div className="io-preloader__item c1">
                <div className="item item--1">
                  <div className="ball__container draggable--ball-green">
                    <img
                      aria-hidden="true"
                      src="/_nuxt/img/ball-green.014fc17.png"
                      className="ball ball--green"
                      alt=""
                    ></img>
                  </div>
                </div>
              ...
              >
                <div className="item item--2">
                  <div className="ball__container draggable--ball-pink">
                    <img
                      aria-hidden="true"
                      src="/_nuxt/img/ball-pink.dfe25ba.png"
                      className="ball ball--pink"
                      alt=""
                    />
                  </div>
                </div>
              ...
              >
                <div className="item item--3">
                  <div className="ball__container draggable--ball-blue">
                    <img
                      aria-hidden="true"
                      src="/_nuxt/img/ball-blue.6492c45.png"
                      className="ball ball--blue"
                      alt=""
                    />
                  </div>
                </div>
              </div>
              <div className="io-preloader__item c2">
                <div className="item item--4">
                  <div className="ball__container draggable--ball-beige">
                    <img
                      aria-hidden="true"
                      src="/_nuxt/img/ball-beige.f39a412.png"
                      className="ball ball--beige"
                      alt=""
                    />
                  </div>
                </div>
              </div>
              <div className="io-preloader__item c3">
                <div className="item item--5">
                  <div className="ball__container draggable--ball-yellow">
                    <img
                      aria-hidden="true"
                      src="/_nuxt/img/ball-yellow.aa2eea5.png"
                      className="ball ball--yellow"
                      alt=""
                    />
                  </div>
                </div>
              </div>
              <div className="io-preloader__item c4">
                <div className="item item--6">
                  <div className="ball__container draggable--ball-purple">
                    <img
                      aria-hidden="true"
                      src="/_nuxt/img/ball-purple.47b2e38.png"
                      className="ball ball--purple"
                      alt=""
                    />
                  </div>
                </div>
              </div>
              <div className="io-preloader__item c5">
                <div className="item item--7">
                  <picture className="draggable draggable--head-first is-not-animating">
                    <img src="" className="head head--first" alt="" />
                  </picture>
                </div>
              </div>
              <div className="io-preloader__item c6">
                <div className="item item--8">
                  <picture className="draggable draggable--head-second is-not-animating">
                    <img src="" className="head head--second" alt="" />
                  </picture>
                </div>
              </div>
              <div className="io-preloader__item c7">
                <div className="item item--9">
                  <picture className="draggable draggable--head-third is-not-animating">
                    <img src="" className="head head--third" alt="" />
                  </picture>
                </div>
              </div>
              <div className="io-preloader__item c8">
                <div className="item item--10">
                  <picture className="draggable draggable--head-fourth is-not-animating">
                    <img src="" className="head head--fourth" alt="" />
                  </picture>
                </div>
              </div>
            </div>
